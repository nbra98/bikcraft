...
function formularioEnviado(resposta) {
  if (resposta.ok) {
    formulario.innerHTML = '<p class="font-2-l" style="grid-column: 1/-1; padding: 1rem; border-radius: 4px; background: #F7F7F7;"><span style="color: #317A00;"><strong>Enviado com sucesso!</strong></span> Retornaremos em breve!</p>';
  } else {
